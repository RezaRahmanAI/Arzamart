...
namespace ECommerce.Infrastructure.Migrations
{
    ...
    [Migration("20260709071646_AddLocationIdsToCustomerAndOrder")]
    partial class AddLocationIdsToCustomerAndOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerce.Core.Entities.AdminActivityLog", b =>
                {
                    ...
                    b.ToTable("AdminActivityLogs", "dbo");
                });
            ...
            modelBuilder.Entity("ECommerce.Core.Entities.ComboItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.Core.Entities.Location.District", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.Core.Entities.Location.Division", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.Core.Entities.Location.Upazila", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.Core.Entities.Shop.DeliveryZone", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("DeliveryZones", "dbo");
                });

            modelBuilder.Entity("ECommerce.Core.Entities.Shop.DeliveryZoneUpazila", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DeliveryZoneId", "UpazilaId")
                        .IsUnique();

                    b.ToTable("DeliveryZoneUpazilas", "dbo");
                });
            ...
            modelBuilder.Entity("ECommerce.Core.Entities.AdminActivityLog", b =>
                {
                    b.HasOne("ECommerce.Core.Entities.ApplicationUser", "PerformedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("ECommerce.Core.Entities.ComboItem", b =>
                {
                    b.HasOne("ECommerce.Core.Entities.Product", "ComboProduct")
                        .WithMany("ComboItems")
            ...
            modelBuilder.Entity("ECommerce.Core.Entities.DeliveryMethod", b =>
                {
                    b.HasOne("ECommerce.Core.Entities.Shop.DeliveryZone", "DeliveryZone")
                        .WithMany()
            ...
            modelBuilder.Entity("ECommerce.Core.Entities.Location.District", b =>
                {
                    b.HasOne("ECommerce.Core.Entities.Location.Division", "Division")
                        .WithMany("Districts")
            ...
            modelBuilder.Entity("ECommerce.Core.Entities.Location.Upazila", b =>
                {
                    b.HasOne("ECommerce.Core.Entities.Location.District", "District")
                        .WithMany("Upazilas")
            ...
            modelBuilder.Entity("ECommerce.Core.Entities.Product", b =>
                {
                    ...
                    b.HasOne("ECommerce.Core.Entities.ProductGroup", "ProductGroup")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("ECommerce.Core.Entities.Shop.DeliveryZone", b =>
                {
                    b.Navigation("DeliveryZoneUpazilas");
                });
