...
export class AppIconComponent {
  ...
  private iconPaths: { [key: string]: string } = {
    ...
    'Flower2': '<path d="m12 5 3-3 3 3"></path><path d="m18 12 3 3-3 3"></path><path d="m12 19-3 3-3-3"></path><path d="m6 12-3-3 3-3"></path><path d="m12 10.5 4-4"></path><path d="m13.5 12 4 4"></path><path d="m12 13.5-4 4"></path><path d="m10.5 12-4-4"></path><circle cx="12" cy="12" r="2"></circle>',
    ...
    'History': '<path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"></path><polyline points="3 3 3 8 8 8"></polyline><path d="M12 7v5l4 2"></path>',
    ...
    'PackagePlus': '<path d="M16 16h6"></path><path d="M19 13v6"></path><path d="M21 10V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l2-1.14"></path><path d="m7.5 4.27 9 5.15"></path><polyline points="3.29 7 12 12 20.71 7"></polyline><line x1="12" y1="22" x2="12" y2="12"></line>',
    'PackageX': '<path d="M21 10V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l2-1.14"></path><path d="m7.5 4.27 9 5.15"></path><polyline points="3.29 7 12 12 20.71 7"></polyline><line x1="12" y1="22" x2="12" y2="12"></line><path d="m17 13 5 5"></path><path d="m22 13-5 5"></path>',
    ...
    'RefreshCw': '<path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"></path><polyline points="16 3 21 3 21 8"></polyline><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"></path><polyline points="8 21 3 21 3 16"></polyline>',
    ...
    'StickyNote': '<path d="M16 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V8Z"></path><path d="M15 3v5h6"></path>',
    ...
    'WhatsApp': '<path fill="currentColor" stroke="none" d="M17.472 14.382c-.301-.15-1.767-.872-2.04-.971-.272-.099-.47-.15-.669.15-.199.3-.77.971-.944 1.171-.174.199-.348.225-.649.075-.301-.15-1.27-.468-2.42-1.494-.894-.798-1.498-1.783-1.674-2.083-.176-.3-.019-.462.131-.61.135-.133.301-.35.451-.525.15-.175.2-.299.301-.499.1-.199.05-.375-.025-.525-.075-.15-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.768-.721 2.016-1.416.248-.695.248-1.29.173-1.415-.074-.125-.272-.199-.573-.35z"></path><path fill="currentColor" stroke="none" d="M12.004 2c-5.517 0-9.992 4.475-9.992 9.991 0 1.763.459 3.474 1.33 4.982L2 22l5.166-1.355c1.464.798 3.111 1.218 4.835 1.218 5.516 0 9.991-4.475 9.991-9.991 0-5.517-4.475-9.991-9.991-9.991zM12.004 20.124c-1.558 0-3.085-.418-4.417-1.21l-.317-.189-3.284.861.875-3.2-.208-.331c-.873-1.391-1.335-3.001-1.335-4.665 0-4.647 3.781-8.428 8.428-8.428s8.428 3.781 8.428 8.428-3.781 8.428-8.428 8.428z"></path>',
    ...
    'ShieldAlert': '<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path><line x1="12" x2="12" y1="8" y2="12"></line><line x1="12" x2="12.01" y1="16" y2="16"></line>',
    'Edit3': '<path d="M12 20h9"></path><path d="M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z"></path>'
  };

  getIconSvg(): SafeHtml {
    const path = this.iconPaths[this.name] || '';
    const svgHtml = `<svg width="${this.size}" height="${this.size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display: block;">${path}</svg>`;
