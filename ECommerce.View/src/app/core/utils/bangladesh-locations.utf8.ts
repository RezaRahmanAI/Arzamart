export const BANGLADESH_LOCATIONS: Record<string, string[]> = {
  "Dhaka": ["Adabor", "Ashulia", "Asulia", "Azimpur", "Badda", "Banani", "Banglamotor", "Banasree", "Baridhara", "Basundhara", "Cantonment", "Chaukbazar", "Demra", "Dhanmondi", "Dohar", "Eskaton", "Farmgate", "Gulshan", "Hazaribagh", "Jatrabari", "Kafrul", "Kalabagan", "Kamrangirchar", "Keraniganj", "Khilgaon", "Khilkhet", "Kotwali", "Lalbagh", "Mirpur", "Mohammadpur", "Motijheel", "New Market", "Pallabi", "Paltan", "Ramna", "Rampura", "Sabujbagh", "Savar", "Shahbagh", "Sher-e-Bangla Nagar", "Shyamoli", "Sutrapur", "Tejgaon", "Uttara", "Vatara", "Wari"],
