...
const OFFERS: OfferDetails[] = [
  {
    ...
    description: "A breathable satin blend with tailored lines that transitions from day to evening. Limited inventory with special pricing just for this pop-up.",
